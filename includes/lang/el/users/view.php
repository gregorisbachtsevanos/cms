...
$txt['action_history'] = 'Ιστορικό ενεργειών';
$txt['date'] = 'Ημερομηνία';
$txt['controller'] = 'Ενότητα';
$txt['action'] = 'Ενέργεια';
$txt['old_value'] = 'Προηγούμενη τιμή';
$txt['new_value'] = 'Νέα τιμή';
$txt['controller_contacts'] = 'Επαφές';
$txt['controller_calendar'] = 'Ραντεβού';
$txt['action_create'] = 'Δημιουργία';
$txt['action_edit'] = 'Επεξεργασία';
$txt['action_delete'] = 'Διαγραφή';