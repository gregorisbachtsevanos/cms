...
<ol class="breadcrumb bc-3" >
	...
	<li>
		<a href="<?php echo $appURL; ?><?php echo $controllerName; ?>"><?php slang('CONTACTS'); ?></a>
	</li>
	<li class="active">
		...
		<div class="tab-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control autogrow" name="iban" value="<?php echo $contact->iban; ?>">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
			...
			<div class="tab-pane" id="tab3">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6">
						<a href="<?php echo $appURL; ?>properties?newClient=<?php echo $contact->id; ?>" class="btn btn-success pull-right">Νέο κατάλυμα</a>
					</div>
				</div>
				<br>
				<div class="row">
...
<?php
	...
	function editNote(id){
		$("#delete_note_button").attr("href", "<?php echo $appURL; ?>contacts/view/<?php echo $contact->id; ?>?delete_note="+id);
		$.post('<?php echo $appURL; ?>contacts/view/<?php echo $contact->id; ?>', {load_note_data: id}, function (data){
			data = $.parseJSON(data);
