  ...
  <body bgcolor="#222">
    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
      <table style="width: 100%;">
        ...
        <h1 style="margin-top: 0px;">Reset your password</h1>
        <div style="color: #636363; font-size: 14px;">
          <p>Hi '.$row->name.',</p>
			<p>We just got a request that you wish to reset your password. You can change your password by clicking on the button below. </p>
        </div>
        <a href="'.$appURL.'login/reset-password/'.$row->id.'-'.$row->auth_hash.'" style="padding: 6px 16px;background-color: #4B72FA;color: #fff;font-weight: bolder;font-size: 16px;display: inline-block;margin: 20px 0px;margin-right: 20px;text-decoration: none;">Change password</a>
        ...
        <div style="color: #A5A5A5; font-size: 12px; margin-bottom: 20px; padding: 0px 50px;">
          You are receiving this email because you requested a password change. If you never requested this change, please ignore this message. In case you continue to receive this email, please let us know.
        </div>
