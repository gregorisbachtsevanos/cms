<?php
$html_body = '<html style="background-color: #222;">
  <body bgcolor="#222">
    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
      <table style="width: 100%;">
        ...
        <h1 style="margin-top: 0px;">Verify your identity</h1>
        <div style="color: #636363; font-size: 14px;">
          <p>Hi '.$row->name.',</p>
			<p>Please verify that it\'s you. Use the following code to confirm your identity.</p>
			<h1>'.$newcode.'</h1>
        </div>
        <a href="#" style="padding: 6px 16px;background-color: #E91E63;color: #fff;font-weight: bolder;font-size: 16px;display: inline-block;margin: 20px 0px;margin-right: 20px;text-decoration: none;">This wasn\'t me</a>
        ...
        <div style="color: #A5A5A5; font-size: 12px; margin-bottom: 20px; padding: 0px 50px;">
          You are receiving this email because you have enabled login verifications. You can change your settings at your <a href="#" style="text-decoration: underline; color: #4B72FA;">account\'s page</a>.
        </div>
